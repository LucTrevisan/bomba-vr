...
var AbstractMesh = class _AbstractMesh extends TransformNode {
  ...
  async optimizeIndicesAsync() {
    ...
    const { OptimizeIndices } = await import("./mesh.vertexData.functions-CXE4SNFB.js");
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-ZASFT3NF.js"), import("./default.fragment-NL77M2S4.js")]);
          } else {
            await Promise.all([import("./default.vertex-WI525XXL.js"), import("./default.fragment-AO55AIZZ.js")]);
          }
...
//# sourceMappingURL=chunk-SDSAJXJV.js.map
